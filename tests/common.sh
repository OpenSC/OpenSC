...
function card_setup() {
	...
	if [ "${TOKENTYPE}" == "kryoptic" ]; then
		...
		generate_key "ML-DSA-65" "06" "ML-DSA-65" || return 1
		# Generate ML-KEM-768 Key pair
		generate_key "ML-KEM-768" "07" "ML-KEM-768" || return 1
		# Generate SLH-DSA-SHA2-192S Key pair
		generate_key "SLH-DSA-SHA2-192S" "08" "SLH-DSA-SHA2-192S" || return 1
