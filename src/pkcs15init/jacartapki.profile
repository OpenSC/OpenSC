#
# PKCS15 r/w profile for JaCarta PKI applet
#
cardinfo {
	label		= "JaCarta PKI";
...
filesystem {
	DF MF {
		...
		EF JaCartaPKI-LogcalExpr-AdminOrUser {
			ACL = *=NONE;
			ACL = UPDATE=NEVER, CRYPTO=NONE, DELETE-SELF=CHV16, GENERATE=NONE, PIN-RESET=NONE, ADMIN=NEVER, READ=NONE;
			file-id = 0030;
			size	= 14;
		...
		EF JaCartaPKI-LogcalExpr-AdminOrUserOrTransport {
			ACL = *=NONE;
			ACL = UPDATE=NEVER, CRYPTO=NONE, DELETE-SELF=CHV16, GENERATE=NONE, PIN-RESET=NONE, ADMIN=NEVER, READ=NONE;
			file-id = 0032;
			size	= 18;
		...
		EF JaCartaPKI-LogcalExpr-AdminOrUserPIN {
			ACL = *=NONE;
			ACL = UPDATE=NEVER, CRYPTO=NONE, DELETE-SELF=CHV16, GENERATE=NONE, PIN-RESET=NONE, ADMIN=NEVER, READ=NONE;
			file-id = 0035;
			size	= 14;
