    ...
    DF MF {
        ...
        DF PKCS15-AppDF {
            ...
            template key-domain {
                ...
                BSO private-key {
                    ACL     = *=NEVER;
                    ACL     = UPDATE=SCBx17, READ=NONE;
                    ACL     = PSO-COMPUTE-SIGNATURE=SCBx17, INTERNAL-AUTHENTICATE=SCBx17, PSO-DECRYPT=SCBx17, GENERATE=SCBx17;
                }
                ...
                BSO public-key {
                    ACL = *=NEVER;
                    ACL = INTERNAL-AUTHENTICATE=SCBx17, GENERATE=SCBx17, UPDATE=SCBx17, READ=NONE;
                }
