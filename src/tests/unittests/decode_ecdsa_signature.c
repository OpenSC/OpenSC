...
static void
torture_valid_format(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_valid_format_leading00(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_valid_format_long_fieldsize(void **state)
{
	int r = 0;
	size_t fieldsize = 3;
	struct sc_context *ctx = NULL;
...
static void
torture_wrong_tag_len(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_wrong_integer_tag_len(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_small_fieldsize(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_long_leading00(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_missing_tag(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
...
static void
torture_missing_integer_tag(void **state)
{
	int r = 0;
	size_t fieldsize = 1;
	struct sc_context *ctx = NULL;
