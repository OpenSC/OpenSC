...
static const char *option_help[] = {
	...
	"Key pair generation",
	"Key generation",
	"Specify the type and length (bytes if symmetric) of the key to create, for example rsa:1024, EC:prime256v1, EC:ed25519, EC:curve25519, GOSTR3410-2012-256:B, AES:16, GENERIC:64 or HKDF:64",
...
static void fill_attributes_seckey(CK_ATTRIBUTE *template, int *n_attrs, int max_attrs)
{
