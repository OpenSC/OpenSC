		...
		struct sc_asn1_entry *asn1_cvc_pubkey, size_t asn1_cvc_pubkey_len, sc_cvc_t *cvc)
{
	...
	sc_format_asn1_entry(asn1_cvc_pubkey + 0, &cvc->pukoid, NULL, 0);
	...
	sc_format_asn1_entry(asn1_cvc_body + 0, &cvc->cpi, NULL, 0);
	...
	sc_format_asn1_entry(asn1_cvcert + 0, asn1_cvc_body, NULL, 0);
		...
		struct sc_asn1_entry *asn1_cvcert, sc_cvc_t *cvc)
{
	...
	sc_format_asn1_entry(asn1_authreq + 0, asn1_cvcert, NULL, 0);
