...
opensc.dll: $(OBJECTS) $(LIBS) $*.def
	link $(LINKFLAGS) /dll /out:$@ /def:$*.def /implib:$*.lib $(OBJECTS) $(LIBS) $(OPENPACE_LIB) $(OPENSSL_LIB) $(ZLIB_LIB) gdi32.lib Shell32.lib user32.lib advapi32.lib ws2_32.lib shlwapi.lib
