...
static int
aes128_encrypt_cmac_ft(const unsigned char *key, int keysize, const unsigned char *input, size_t length,
...
static int
aes128_encrypt_cmac(const unsigned char *key, int keysize, const unsigned char *input, size_t length,
