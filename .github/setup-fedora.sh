...
DEPS="make /usr/bin/xsltproc docbook-style-xsl autoconf automake libtool gawk bash-completion vim-common softhsm openssl diffutils openpace openpace-devel"
