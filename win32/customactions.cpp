...
MD_REGISTRATION minidriver_registration[] = {
	...
	/* Japanese Individual Number Card (My Number Card), contact interface */
	{TEXT("JPKI (02)"),                       {0x3b,0xda,0x13,0xff,0x81,0x31,0xfb,0x46,0x80,0x12,0x39,0x2f,0x31,0xc1,0x73,0xc6,0x01,0xc0,0x3b},
                                          19, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (03)"),                       {0x3b,0xc5,0xff,0x81,0x31,0xfb,0x45,0x80,0x73,0xc6,0x01,0x00,0x00},
                                          13, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (04)"),                       {0x3b,0xf5,0x91,0x00,0xff,0x91,0x81,0x71,0xfe,0x40,0x00,0x42,0x00,0x01,0x00,0xd1,0xd6},
                                          17, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (05)"),                       {0x3b,0xf5,0x91,0x00,0xff,0x91,0x81,0x71,0xfe,0x40,0x00,0x42,0x00,0x01,0xb3,0xa1,0x15},
                                          17, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	/* Japanese Individual Number Card (My Number Card), contactless interface.
	 * ATR constructed from ATQB by PC/SC part 3 compliant readers.
	 * Readers that include the (random) PUPI in the ATR cannot be matched. */
	{TEXT("JPKI (06)"),                       {0x3b,0x88,0x80,0x01,0x00,0x00,0x05,0xe0,0xb3,0x81,0xa1,0x00,0x7f},
                                          13, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (07)"),                       {0x3b,0x88,0x80,0x01,0x00,0x00,0x41,0xe0,0xb3,0x81,0xa1,0x00,0x3b},
                                          13, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (08)"),                       {0x3b,0x88,0x80,0x01,0x00,0x4b,0x51,0xff,0x00,0x81,0xd1,0x00,0xbc},
                                          13, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
	{TEXT("JPKI (09)"),                       {0x3b,0x88,0x80,0x01,0x00,0x4b,0x51,0xff,0xb3,0x81,0xd1,0x00,0x0f},
                                          13, {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff}},
    ...
    /* from nqApplet.c */
    {TEXT("nqApplet JCOP4"),                  {0x3b,0xd5,0x18,0xff,0x81,0x91,0xfe,0x1f,0xc3,0x80,0x73,0xc8,0x21,0x10,0x0a},
                                          15, {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}},
    {TEXT("nqApplet JCOP4.52"),               {0x3b,0xd8,0x18,0xff,0x81,0xb1,0xfe,0x45,0x1f,0xc3,0x80,0x73,0xc8,0x21,0x10,0x52,0xb7,0x7f,0xf8},
                                          19, {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}},
    {TEXT("nqApplet JCOP4 RFID"),             {0x3b,0x85,0x80,0x01,0x80,0x73,0xC8,0x21,0x10,0x0e},
