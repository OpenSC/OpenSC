...
WIXFLAGS = \
	...
	-d ENABLE_TOOLS \
	-d ENABLE_NOTIFY
#Include support for PKCS#11
PKCS11_DEF = /DENABLE_PKCS11
WIXFLAGS = -d ENABLE_PKCS11 $(WIXFLAGS)
...
COPTS = /nologo /Zi /GS /W3 /WX /D_CRT_SECURE_NO_DEPRECATE /D_CRT_NONSTDC_NO_WARNINGS /DHAVE_CONFIG_H \
	$(DEFS) $(DEBUG_DEF) $(OPENPACE_DEF) $(OPENSSL_DEF) $(ZLIB_DEF) $(PKCS11_DEF) $(MINIDRIVER_DEF) $(SM_DEF) $(TESTS_DEF) $(OPENSSL_EXTRA_CFLAGS) \
